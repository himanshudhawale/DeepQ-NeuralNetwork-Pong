...
filePath = '/users/hdhawale/gitfolder/MachineLearning-Research/generalization/atari/BaseDQN_atari/results/Pong/'
resultPath = '/users/hdhawale/gitfolder/MachineLearning-Research/generalization/atari/BaseDQN_atari/results/Pong/pong_results/'
envName = 'Pong'
...
def main():
  ...
  logger.log('Tennis. Storing weights after every 1000000 steps')
